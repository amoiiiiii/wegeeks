...
const AbsenceFormModal = ({ onClose = () => {} }) => {
  ...
  return (
    <dialog id="absenceFormModal" className="modal" open>
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input
              ...
              className="input input-bordered w-full"  // Changed width to full
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              rows="4"  // Increased rows for a longer textarea
              required
            />
          </div>
          <div className="mb-4">
            ...
            <input
              ...
              className="file-input w-full"  // Changed width to full
              accept=".img,.jpg,.jpeg,.pdf"  // Restrict file types
            />
          </div>
          <button
            type="submit"
